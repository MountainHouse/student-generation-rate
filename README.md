...
The Household Simulation page is organized into collapsible/reorderable tools. The default visible tools are model settings, scenario homes, and validation summary; additional diagnostics, scoring, run environment, simulation info, and custom chart tools can be added from the Tools menu.
